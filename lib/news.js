...
// Urutan: Google News → Kontan RSS (khusus query umum/makro)
// Jika sumber utama gagal/kosong, otomatis coba sumber berikutnya
// Catatan: sebelumnya ada rencana fallback ketiga ke "Detik Finance RSS" yang
// disebut di komentar tapi URL-nya tidak pernah benar-benar diverifikasi/dipakai
// di kode — dihapus agar dokumentasi sesuai perilaku sebenarnya.
const NEWS_SOURCES = {
