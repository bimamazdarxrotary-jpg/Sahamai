...
function getSektorContext(sektor) {
  const konteks = {
    ...
    'Perbankan':      'KONTEKS: Dominasi asing (BBCA/BBRI/BMRI masuk MSCI). Sensitif BI Rate, NPL, NIM. Pemotongan BI Rate = katalis positif.',
    ...
    'Konsumer':       'KONTEKS: Defensif, outperform risk-off. Sensitif inflasi CPO/gandum, daya beli. Musiman Lebaran/Natal signifikan.',
    'Properti':       'KONTEKS: Sensitif KPR/BI Rate, siklus panjang. Stimulus PPN 0% = katalis. Likuiditas kecil rawan manipulasi.',
    'Infrastruktur':  'KONTEKS: BUMN sensitif APBN/PSN. IKN = katalis. Saham politik, utang tinggi, cash flow berisiko.',
    'Barang Baku':    'KONTEKS: Terkait LME (nikel, tembaga, emas). TPIA sensitif naphtha. Cyclical, demand China driven.',
  ...
  return key ? konteks[key] : `KONTEKS: Analisis ${sektor} dalam konteks IHSG. Perhatikan rotasi sektor dan posisi asing.`;
}
...
function sanitizeAIOutput(parsed, priceData) {
  ...
  // Migrasi field lama ke field baru jika ada
