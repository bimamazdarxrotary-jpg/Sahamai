...
const MODEL    = 'meta-llama/llama-4-maverick-17b-128e-instruct'; // Llama 4 Maverick — lebih besar dari Scout
...
async function callAI(params) {
  ...
  var newsData     = params.newsData   || null;
  ...
  var newsContext = newsData && newsData.summary
    ? '\n\n' + newsData.summary
